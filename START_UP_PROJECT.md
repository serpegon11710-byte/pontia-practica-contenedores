...
Adicionalmente hay cuatro metodos de arranque por entorno (pensados para testing), definidos en la carpeta bootstrap
...
**start-api-test.py** : Aranca el api con las variables definidas en el propio script. 
...
**start-api-compose.py** : Crea un docker compose con las variables definidas. 
La configuración de la BBDD es transparente ya que se crea dentro del docker.
**start-api-compose-test.py** : Crea un docker compose con las variables definidas en el propio script. 
